...
@section('content')
    <div class="container mt-5">
        <form action="/update-photo/{{ $photo->id_photo }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('patch')
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 pb-4 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('images/' . $photo->photo) }}" id="hop" class="rounded img-fluid"
                                                alt="" width="295px">
                                        </div>
                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input type="text" name="title" class="form-control" id="title" value="{{ $photo->judul }}" placeholder="Enter title">                                             
                                            </div>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="text-right">
                                                ...
                                                <button type="submit" id="submit" name="submit"
                                                    ...
                                                    <i class="fas fa-solid fa-upload"></i> Edit
                                                </button>
                                            </div>
                                        </div>
                                    </div>
